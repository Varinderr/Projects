...
s1.async=true;
s1.src='https://embed.tawk.to/5b3d92aa6d961556373d6bd1/default';
s1.charset='UTF-8';
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <a class="navbar-brand pull-right" href><span class="glyphicon glyphicon-user"></span> <?=$_SESSION['name'];?> </a>
